...
# We use a powerful model for the final answer
llm = ChatGroq(model_name="llama-3.3-70b-versatile", temperature=0.3)

# We use the Vision model for "Just-in-Time" image analysis
...
def chat_with_data(query: str):
    ...
    for doc in results:
        ...
        if "image_paths" in doc.metadata and doc.metadata["image_paths"]:
            ...
            # You can loop through all if you want comprehensive analysis
...
if __name__ == "__main__":
    # Simulate a question that requires seeing a diagram
    test_q = "Explain the vessel image example in Steganography."
    answer = chat_with_data(test_q)
    print("\nAI Answer:\n")
    print(answer)